namespace assignment8ex1
{
    class Program
    {
        ...
        {
            SongDelegate songDeleg = new SongDelegate(HereComesTheSun.chorus);
            songDeleg += HereComesTheSun.verse1;
            songDeleg += HereComesTheSun.chorus;
            songDeleg += HereComesTheSun.verse2;

            songDeleg += HereComesTheSun.chorus2;
            songDeleg += HereComesTheSun.verse3;
            songDeleg += HereComesTheSun.chorus;
            songDeleg += HereComesTheSun.chorus;

            songDeleg += HereComesTheSun.end;
